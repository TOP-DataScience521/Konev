...
otkuda_hod = input('Введите координаты положения Короля: ')
kod_otkuda_hod = int(doska[otkuda_hod])

kuda_hod = input ('Введите координаты предстоящего хода: ')
kod_kuda_hod = int(doska[kuda_hod])

if abs(kod_otkuda_hod - kod_kuda_hod) in [1, 8, 9, 7]:
