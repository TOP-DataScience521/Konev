...
model = Sequential(
    [
        ...
        Dense(units=128, activation='relu', name='hidden1'),# 1 слой 
        Dense(units=64, activation='relu', name='hidden2'),# 2 слой  
        Dense(units=32, activation='relu', name='hidden3'),# 3 слой  
...
#Epoch 50/50
#23/23 [==============================] - 0s 3ms/step - loss: 0.0799 - mae: 0.2032 - val_loss: 0.2867 - val_mae: 0.3357
#
#4/4 - 0s - loss: 0.1725 - mae: 0.2541 - 27ms/epoch - 7ms/step
#4/4 [==============================] - 0s 1000us/step