...
for n in range(2, 10):
    # начальное положение центроид решил все таки задать вручную
    fixed_centroids = [
        [1.1, 1.1],  # 1 - левый нижний угол
        [8.8, 8.8],  # 2 - правый верхний угол  
        [1.8, 8.1],  # 3 - левый верхний
        [8.1, 1.8],  # 4 - правый нижний
        [1.5, 5.1],  # 5 - левый центр
        [5.1, 1.5],  # 6 - нижний центр
        [5.5, 8.5],  # 7 - верхний центр
        [8.5, 5.5],  # 8 - правый центр
        [5.8, 5.8]   # 9 - центр
    ]

# Берем только первые n центроид
    centroids = array(fixed_centroids[:n])
