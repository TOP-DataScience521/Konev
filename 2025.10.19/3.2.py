...
# относительно MEDV были выбраны все переменные выше 0,6 по модулу
# это переменные RM ,LSTAT 
# Вариант 3.2   test_rate = 0.25
